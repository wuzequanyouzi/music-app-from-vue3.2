...
export const ERROR_CODE_MESSAGE: any = {
 ...
 * @author: youzi
 */
export const successReponseInterceptor = (axiosResponse: any) => {
  const {
 ...
 * @author: youzi
 */
export const errResponseInterceptor = (errResponse: any) => {
  /* 请求为主动中断 */
